...
function snippetsToNavBar() {
    ...
    if (cont) {
        ...
        for(let i = 0; i < groupNames.length; i++) {
            ...
            btnHeader.classList.add("accordion", "accordion-header", "font-branded", "font-lg", "bg-clr-dark", "font-clr-light");
            btnHeader.innerHTML = groupNames[i];
            cont.appendChild(btnHeader);

            div = document.createElement("div");
            div.classList.add("panel", "font-branded", "font-clr-light", "bg-clr-dark");
            ...
            for(let j = 0; j < s.length; j++) {
                ...
                btnContent.classList.add("accordion", "accordion-item", "font-branded", "font-sm", "bg-clr-dark", "font-clr-light");
...
function snippetsToScreen() {
    document.getElementById('lbl-snippets').value = JSON.stringify(snippets, null, 2);
    snippetsToNavBar();
    snippetToScreen();
}
